...
const Doctors = () => {
  ...
  // 1. Component mount hone par doctors list fetch karein
  useEffect(() => {
    getAllDoctors()
  }, [])

  // 2. Filter logic: 'allDoctors' variable se mapping
  const applyFilter = () => {
    if (speciality) {
  ...
  // 3.Jab 'allDoctors' ya 'speciality' change ho tab filter apply ho
  useEffect(() => {
    applyFilter()
  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        {/* Left Side Filter Menu Container */}
        <div
